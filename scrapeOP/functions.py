...
def scrape_page_typeA(page, sport, country, tournament, SEASON,curr='2022-2023'):
    link = 'https://www.oddsportal.com/{}/{}/{}-{}/results/page/1/#/page/{}'.format(sport, country, tournament, SEASON, page)
    print(link)
    if curr=='2022-2023' and page==1:
        link='https://www.oddsportal.com/basketball/usa/nba/results/'
    elif  curr=='2022-2023':
...
def scrape_current_tournament_typeA(sport, tournament, country, SEASON, start_page=1,max_page = 25):
    global driver
    ...
    data_df.to_csv('./{}_FULL/{}_{}_{}_FULL.csv'.format(tournament,tournament, SEASON,start_page), sep=';', encoding='utf-8', index=False)
    data_df[['Home_id', 'Away_id', 'Bookmaker', 'OddHome', 'OddAway', 'Date', 'Score_home', 'Score_away','Season']].to_csv('./{}/{}_{}_{}.csv'.\
        format(tournament,tournament, SEASON,start_page), sep=';', encoding='utf-8', index=False)
...
def scrape_league_typeA(Season, sport, country1, tournament1, nseason, current_season = 'yes', start_page=1,max_page = 25):
    ...
    for i in range(nseason):
        ...
        scrape_current_tournament_typeA(sport = sport, tournament = tournament1, country = country1, SEASON = SEASON1, start_page=start_page,max_page = max_page)
...
def scrape_oddsportal_historical(sport = 'football', country = 'france', league = 'ligue-1', start_season = '2019-2020', nseasons = 1, current_season = 'yes',start_page=1, max_page = 25):
  ''' sport : sport as mentioned on the oddsportal website 
      country : country as mentioned on oddsportal website 
      league : league as mentioned on oddsportal website
  ...
  if sport in ['baseball','esports','basketball','darts', 'american-football', 'volleyball']:
    ...
    df = scrape_league_typeA(Season = start_season, sport = sport, country1 = country, tournament1 = league, nseason = nseasons, current_season = current_season,
                            start_page=start_page ,max_page = max_page)
    df = create_clean_table_two_ways(df)
  #elif sport in ['tennis']:
